"""H-04 — the coverage-gap issue opener behind ``cdx surface-gaps`` (offline default).

Turns a :class:`~custodex.coverage.CoverageReport` (EPIC A) and its
:func:`~custodex.coverage.suggest_owners` output into a **tracker issue**
...
:mod:`custodex.pr` / :mod:`custodex.registry`).
...
def _issue_body(suggestions: tuple[OwnerSuggestion, ...]) -> str:
    ...
    lines = [
        "Automated coverage report opened by `cdx` (bot-generated).",
        "",
