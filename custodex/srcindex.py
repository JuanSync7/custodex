...
Reuses :func:`custodex.inventory.discover_files`/``discover_symbols`` (no
AST re-impl — K0) and :mod:`custodex.featurecatalog`. Pure (K1 — the only
...
bad package root via inventory's :class:`custodex.errors.InventoryError`
(K8).
...
def render_source_wiki_md(index: SourceIndex) -> str:
    ...
    lines: list[str] = [
        ...
        (
            ...
            "catalog — **do not hand-edit**. Run `cdx wiki` (R-08) to regenerate."
        ),
        "",
